 ...
 */
function cw_blocks_register_squares_block() {
	...
	register_block_type( 'cw-blocks/squares', array(
		'style' => 'squares-block',
		'editor_style' => 'squares-block-editor',
		'editor_script' => 'squares-block',
	) );
...
add_action( 'init', 'cw_blocks_register_squares_block' );
?>